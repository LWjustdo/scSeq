...
then 
    ...
    echo ""
    echo "           Contact:lwan@dragondropinn.com, 2018-10-30"
    echo ""
    exit 0
fi
...
--genomeDir /home/longzhao/scSeq/star_index_mouse \
--readFilesIn $R2 \
...
wait
########## featureCounts ######################
/data/biosoft/subread-1.6.3-Linux-x86_64/bin/featureCounts -a /data/DataBase/GENECODE/GRCm38_mouse/gencode.vM20.annotation.gtf -R BAM -g gene_name -o $prefix.featureCounts  ./$prefix.Aligned.sortedByCoord.out.bam -T 8 &>$prefix.featureCounts.log
